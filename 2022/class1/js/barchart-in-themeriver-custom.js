...
const setting_up_barchart = function(data){
    console.log(data);
    let data_tt = data.filter(datum => {return datum[keyHint] === 'total'});
    ...
    for(; i < data_tt.length; i++){
        ...
        //data_tt[i]['confirmed cases'] = data_tt[i]['confirmed cases'] - data_hb[i]['confirmed cases'];
        //data_tt[i]['deaths'] = data_tt[i]['deaths'] - data_hb[i]['deaths'];
        //data_tt[i]['death toll'] = data_tt[i]['death toll'] - data_hb[i]['death toll'];
    }
